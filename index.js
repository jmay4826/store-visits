...
app.get('/api/analytics/tags', isLoggedIn, controller.getCommentsByTag);
...
app.listen(process.env.PORT, process.env.IP || null, () =>
  console.log(`Listening on ${process.env.PORT} and ${process.env.IP}`));
