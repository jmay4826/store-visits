 ...
 */
  angular.module('cfp.loadingBarInterceptor', ['cfp.loadingBar']).config([
    ...
    function ($httpProvider) {
       ...
       */
          const latencyThreshold = cfpLoadingBar.latencyThreshold;
       ...
       */
          function isCached(config) {
            ...
            const cached = cache !== undefined ? cache.get(config.url) !== undefined : false;
 ...
 */
  angular.module('cfp.loadingBar', []).provider('cfpLoadingBar', function () {
    ...
    this.startSize = 0.02;
    this.parentSelector = '#loading-bar-container';
    ...
    this.$get = [
      ...
      function ($injector, $document, $timeout, $rootScope) {
        let $animate;
        let $parentSelector = this.parentSelector,
       ...
       */
        function _start() {
          ...
          const $parent = angular.element(parent);
          const $after = parent.lastChild && angular.element(parent.lastChild);
       ...
       */
        ...
        function _complete() {
          ...
          completeTimeout = $timeout(function () {
            const promise = $animate.leave(loadingBarContainer, _completeAnimation);
